<?php get_header(); ?>
	...
	<div class="rough-edge"></div>
	<ul class="what-we-do">
		<li><i class="fa fa-server fa-5x"></i><p>Placeholder</p></li>
		<li><i class="fa fa-cc-visa fa-5x"></i><p>Placeholder</p></li>
		<li><i class="fa fa-picture-o fa-5x"></i><p>Placeholder</p></li>
		<li><i class="fa fa-desktop fa-5x"></i><p>Placeholder</p></li>
		<li><i class="fa fa-paper-plane fa-5x"></i><p>Placeholder</p></li>
		<li><i class="fa fa-code fa-5x"></i><p>Placeholder</p></li>
	...
	<h2>Why We Do It</h2>
	<div class="rough-edge"></div>
	<p class="whoweare-copy">Curabitur facilisis nisl purus, venenatis accumsan nisi viverra
	tincidunt. Etiam nunc elit, sagittis quis aliquam a, volutpat a mi.
	Proin iaculis est vitae aliquam consequat. Sed ac sagittis lorem.
	Cras arcu justo, faucibus dignissim vehicula at, pharetra eget odio.
	In mattis ex ligula, eget pulvinar erat vehicula quis. Proin molestie
	...
	<h2>Who We Are</h2>
	<div class="rough-edge"></div>
	<p class="whoweare-copy">Praesent tristique, arcu in hendrerit gravida, sem odio iaculis
	lectus, at eleifend metus diam ac dui. Integer efficitur congue
	eleifend. Donec eleifend tincidunt risus in vestibulum.
	Suspendisse condimentum nulla quis odio mattis faucibus.

	Integer sagittis blandit mi, at ullamcorper risus euismod id. Integer
